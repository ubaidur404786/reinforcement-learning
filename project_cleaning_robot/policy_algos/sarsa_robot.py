...
class CleaningRoom:
    ...
    def step(self, action):
        ...
        reward -= min(self.visit_count[new_pos], 5)
...
class SARSAAgent:
    ...
    def learn(self, s, a, r, ns, na):
        ...
        # SARSA:
        # Q(s,a) ← Q(s,a) + lr * (r + γ*Q(s',a') − Q(s,a))
        self.q[x,y,a] += self.lr * (
            r + self.gamma * self.q[nx,ny,na]
            - self.q[x,y,a]
        )
...
for ep in range(1, EPISODES+1):
    ...
    for step in range(MAX_STEPS):
        ...
        # finish only when all clean AND back home
